...
const representarCardsProductos = () => {
    ...
    for(let i=0; i<productosGlobal.length; i++){
        ...
        <section value="${categoriaLower}">
            <img src="${productoo.foto}" alt="${productoo.nombre}" id="foto-cards"></img>
            ...
            <ul>
                ...
                <li>${productoo.edadDesde ? 'Desde '+ productoo.edadDesde + ' año': ' ' }</li>
                <li>${productoo.edadHasta ? 'Hasta '+ productoo.edadHasta + ' años': ' ' }</li>
            </ul>
        </section>
        `
